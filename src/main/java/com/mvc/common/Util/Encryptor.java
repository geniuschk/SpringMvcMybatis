...
public class Encryptor {
    ...
    public static void main(String[] args) throws Exception {
        if (args.length == 1 || args.length == 2) {
            ...
            if (CommonUtil.isLoggable) System.out.println(plainText + ":" + encryptedString);
        } else {
          if (CommonUtil.isLoggable) System.out.println("USAGE: java AES string-to-encrypt [secretKey]");
        }
    }
